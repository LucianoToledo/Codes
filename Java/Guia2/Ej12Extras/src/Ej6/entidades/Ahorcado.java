...
public class Ahorcado {
    ...
    public Ahorcado(String[] vector, int letrasEncontradas, int jugadasMax) {
        this.vector = vector;
    ...
    public String toString() {
        return "AhorcadoServicio{" + "vector=" + vector + ", letrasEncontradas=" + letrasEncontradas + ", jugadasMax=" + jugadasMax + '}';
    }
