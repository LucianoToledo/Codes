...
import Ej12.Servicio.PersonaServicio;
...
public class Ej12 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingrese dia, mes, anio a comparar");
        int dia = input.nextInt();
        int mes = input.nextInt();
        int anio = input.nextInt();

        Date fechaComparar = new Date(anio - 1900, mes - 1, dia);
        
        if(personaServicio.menorQue(persona, fechaComparar)){
