...
public class Familia {
    ...
    public Familia(String id_familia, String nombre, int edad_minima, int edad_maxima, int num_hijos, String email) {
    ...
    public String toString() {
        return "Familia{" + "id_familia=" + id_familia + ", nombre=" + nombre + ", edad_minima=" + edad_minima + ", edad_maxima=" + edad_maxima + ", num_hijos=" + num_hijos + ", email=" + email + '}';
    }
