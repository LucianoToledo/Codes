...
public class Casa {
    ...
    private ArrayList<Estancia> estanciasCasas;
    ...
    public Casa(int id_casa, String calle, int numero, String codigo_postal, String ciudad, String pais, Date fecha_desde, Date fecha_hasta, int tiempo_minimo, int tiempo_maximo, double precio_habitacion, String tipo_vivienda, ArrayList<Estancia> estanciasCasas, ArrayList<Familia> familias, ArrayList<Comentario> comentarios) {
    ...
    public ArrayList<Estancia> getEstanciasCasas() {
        return estanciasCasas;
    }

    public void setEstanciasCasas(ArrayList<Estancia> estanciasCasas) {
    ...
    public String toString() {
        return "Casa{" + "id_casa=" + id_casa + ", calle=" + calle + ", numero=" + numero + ", codigo_postal=" + codigo_postal + ", ciudad=" + ciudad + ", pais=" + pais + ", fecha_desde=" + fecha_desde + ", fecha_hasta=" + fecha_hasta + ", tiempo_minimo=" + tiempo_minimo + ", tiempo_maximo=" + tiempo_maximo + ", precio_habitacion=" + precio_habitacion + ", tipo_vivienda=" + tipo_vivienda + ", estanciasCasas=" + estanciasCasas + ", familias=" + familias + ", comentarios=" + comentarios + '}';
    }
